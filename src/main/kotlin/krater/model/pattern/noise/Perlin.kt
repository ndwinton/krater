...
// Original from https://mrl.cs.nyu.edu/~perlin/noise/
// via https://rosettacode.org/wiki/Perlin_noise#Kotlin
...
object Perlin {
    ...
    // See http://adrianb.io/2014/08/09/perlinnoise.html

    fun octaveNoise(x: Double, y: Double, z: Double, octaves: Int, persistence: Double): Double {
        var total = 0.0
        var frequency = 1.0
        var amplitude = 1.0
        var maxValue = 0.0
